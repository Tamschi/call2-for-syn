...
| --------- | ------------------ | -------------------------------- |
| 2-3.0.3-4 | :white_check_mark: |                                  |
| 1.0.2-3   | :white_check_mark: |                                  |
| 1.0.0-1   | :x:                | Erroneous.                       |
...
Security advisories are published through [the respective section on this repository here](https://github.com/Tamschi/call2-for-syn/security/advisories) and [RustSec/advisory-db](https://github.com/RustSec/advisory-db).
...
I'll try to make this as painless as possible where manual changes are required, but a simple [`cargo update -p call2-for-syn`](https://doc.rust-lang.org/cargo/commands/cargo-update.html) should do the trick in most cases.
